<%@ Page Title="Quiz Submitted" Language="C#" MasterPageFile="~/authUser/Student/Student.Master" AutoEventWireup="true" CodeBehind="QuizSubmitted.aspx.cs" Inherits="Learning_Management_System.authUser.Student.QuizSubmitted" %>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'QuizSubmitted.aspx/GetSubmissionResult',
                        data: JSON.stringify({ quizId: quizId }),
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'json',
